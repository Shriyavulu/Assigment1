...
public class AssignmentExceptionHandler {
	...
	public ResponseEntity<Object> handleAPIRequestException(AssignmentException vechiclesException) {
		HttpStatus httpStatus = vechiclesException.getStatusCode();
		AssignmentException exception = new AssignmentException(httpStatus, vechiclesException.getMessage());
